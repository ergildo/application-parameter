...
public class ApplicationResourceIT {
    ...
    private static final String DEFAULT_DESCRIPTIOM = "AAAAAAAAAA";
    private static final String UPDATED_DESCRIPTIOM = "BBBBBBBBBB";
    ...
    public static Application createEntity(EntityManager em) {
        Application application = new Application()
            .name(DEFAULT_NAME)
            .descriptiom(DEFAULT_DESCRIPTIOM);
        return application;
    }
    /**
    ...
    public static Application createUpdatedEntity(EntityManager em) {
        Application application = new Application()
            .name(UPDATED_NAME)
            .descriptiom(UPDATED_DESCRIPTIOM);
        return application;
    }
    ...
    public void createApplication() throws Exception {
        ...
        assertThat(testApplication.getDescriptiom()).isEqualTo(DEFAULT_DESCRIPTIOM);
    }
    ...
    public void getAllApplications() throws Exception {
        ...
        restApplicationMockMvc.perform(get("/api/applications?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].descriptiom").value(hasItem(DEFAULT_DESCRIPTIOM.toString())));
    }
    ...
    public void getApplication() throws Exception {
        ...
        restApplicationMockMvc.perform(get("/api/applications/{id}", application.getId()))
            ...
            .andExpect(jsonPath("$.descriptiom").value(DEFAULT_DESCRIPTIOM.toString()));
    }
    ...
    public void updateApplication() throws Exception {
        ...
        assertThat(testApplication.getDescriptiom()).isEqualTo(UPDATED_DESCRIPTIOM);
    }
