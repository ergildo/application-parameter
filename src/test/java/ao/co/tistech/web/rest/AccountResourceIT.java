...
import ao.co.tistech.config.Constants;
import ao.co.tistech.domain.Authority;
import ao.co.tistech.domain.User;
import ao.co.tistech.repository.AuthorityRepository;
import ao.co.tistech.repository.UserRepository;
import ao.co.tistech.security.AuthoritiesConstants;
import ao.co.tistech.service.MailService;
import ao.co.tistech.service.UserService;
import ao.co.tistech.service.dto.PasswordChangeDTO;
import ao.co.tistech.service.dto.UserDTO;
import ao.co.tistech.web.rest.errors.ExceptionTranslator;
import ao.co.tistech.web.rest.vm.KeyAndPasswordVM;
import ao.co.tistech.web.rest.vm.ManagedUserVM;
